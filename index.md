...
<p align="center" style="padding:20px;" >
 ...
 Note that this analysis was done **purely from the speaker's point of view**, we don't take into account in which newspaper or at what time period did the speaker utter this quotation.
...
and we can translate this into the likelihood of a speaker speaking about the environment, given he has feature f. 
...
<div style="text-align: center"><iframe src="resources/hist_all.html" width="800" height="600"></iframe></div>
...
<div style="text-align: center"><iframe src="resources/pie_2018.html" width="500" height="500"></iframe></div>

<div style="text-align: center"><iframe src="resources/pie_2019.html" width="500" height="500"></iframe></div>

<div style="text-align: center"><iframe src="resources/pie_2020.html" width="500" height="500"></iframe></div>
...
- Environmental topics is almost equally distributed among the top 10 news sources. Especially speakers belonging to the Democratic party were over-represented and the right-winged news magazine breitbart quoted people from that party surprisingly often, something that one would not expect. 
